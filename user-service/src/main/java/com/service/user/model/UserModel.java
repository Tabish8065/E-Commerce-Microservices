...
public class UserModel {
	...
	/*
	 * The class is used to create a user model in the database using JPA and
	 * Hibernate Validations are provided in form of annotations here Entity :-
	 * UserModel Attributes :- -> id @AutoGenerated int (Primary key) -> firstName
	 * varchar NotNull, -> lastName varchar, -> email varchar NotNull @Email, ->
	 * password varchar Bycrypted NotNull, -> phoneNumber varchar minLength and
	 * maxLength = 10 and NotNull
	 */
